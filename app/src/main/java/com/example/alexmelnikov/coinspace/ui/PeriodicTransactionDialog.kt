...
class PeriodicDialog : DialogFragment() {
    ...
    private fun initUI() {
        database.getAllOperations()
            ...
            .subscribe({ operationsList -> initOperationsRV(operationsList) },
                {
                })
    }
    ...
    inner class PeriodicOperations(val operations: MutableList<DeferOperation>) :
        ...
        override fun onCreateViewHolder(
            ...
            val view = inflater.inflate(R.layout.periodic_operation_rv_item, parent, false)
            val holder = CurrencyHolder(view)
            holder.itemView.click_frame.setOnLongClickListener {
